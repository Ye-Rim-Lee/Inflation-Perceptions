...
Economic voting is a well-established theory of voting behavior: voters reward or punish incumbents based on economic conditions (Campbell et al. 1980). Empirical evidence has supported the general premise across time and contexts, reinforcing the idea that voters, regardless of party or other differences, value a good economy (Kiewiet 1984; see Lewis-Beck and Stegmaier 2007 and Linn et al. 2010 for reviews) While this construction of the economy as a valence issue is useful and longstanding, it is insufficient to explain its full connection to voting behavior. This sociotropic outlook may be complicated by or contingent upon class (Abramson et al. 2010), income (Bartels 2016), unemployment (Wright 2012), political context (Anderson 2007), deindustrialization (Baccini and Weymouth 2021) and other factors. In short, while the principle of economic voting generally holds, it is influenced by a range of conditions. Lewis-Beck and Nadeau (2011) codify these ideas into a definition of economic voting as having three dimensions: valence, position, and patrimony, which describe the ways voters balance social and personal conditions, opinions on economic issues, and economic standing in their voting behavior. The positional dimension captures the effect of policy positions on voting, such as favoring tax cuts, reducing the deficit, or expanding public assistance  (e.g. Alvarez and Nagler 1995; 1998), while the patrimony dimension focuses on relative economic status and wealth, as represented by property and asset ownership (e.g. Costa Lobo 2013; Quinlan and Okolikj 2022). 

Inflation’s salience for the first time in decades offers a renewed opportunity to examine the dimensions of economic voting, motivated reasoning, and the tradeoffs voters make between pocketbook and sociotropic concerns. Retrospective analysis (Verstyuk 2004) predicts support for the Republican party during periods of high inflation, particularly in presidential elections from 1944-1992, and pre-election polls suggested that inflation might drive vote choice in the 2022 midterm elections (Montanaro 2022; Safarpour et al. 2022), however Mutz and Mansfield (2024) find little evidence that it did so. Afzal’s (2024a; 2024b) work with ANES Pilot Study data collected early in the 2024 presidential election cycle found that support for the incumbent is conditioned by personal economic difficulties and experience with inflation, particularly for voters with lower levels of education. Partisan motivated reasoning  indicates that voter perceptions of inflation will be more favorable for those who identify with the incumbent party (Bartels 2002; Evans and Andersen 2006; Evans and Pickup 2010; Gerber and Huber 2010; Enns et al. 2012; Dickerson and Ondercin 2017; Donovan et al. 2020). The severity of inflation may complicate this relationship (Dickerson 2016) and minimize partisan differences when voters experience similar economic conditions (Parker-Stephen 2013; Stanig 2013). This paper adds to the limited empirical work on the influence of inflation on vote choice in modern U.S. presidential elections by using a large sample of voters in a battleground state. 
...
The authors have no financial or personal relationships with other people or organizations that could inappropriately influence (bias) this work. Financial support for this research was received from the Michigan State University Institute for Public Policy and Social Research.
